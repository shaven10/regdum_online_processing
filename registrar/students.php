...
$params = [];
if ($search) {
    $where[] = '(u.first_name LIKE ? OR u.last_name LIKE ? OR u.student_id LIKE ? OR u.email LIKE ?)';
...
$stmt = $db->prepare('SELECT u.*, sp.course, sp.year_level, sp.enrollment_status
    ...
    WHERE ' . implode(' AND ', $where) . ' ORDER BY u.last_name LIMIT 50');
$stmt->execute($params);
    ...
    <div class="card-body">
        ...
        <?php elseif (!empty($students)): ?>
            <table class="data-table">
                <thead><tr><th>Student ID</th><th>Name</th><th>Email</th><th>Course</th><th>Year</th><th>Status</th></tr></thead>
                <tbody>
